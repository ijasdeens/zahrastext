...
<body onload="window.print()">
  ...
  <input type="hidden" id="base_url" value="<?php echo base_url()?>">
   <div id="invoice-POS">
    ...
    <div id="mid">
      <div class="info">
        <h2>Customer's credit details</h2>
                          ...
                          <table>
                            ...
                            <?php if($results!=0):?>
                              <?php foreach($results as $result):?>
                                <?php
                                     $sumofdebt+=floatval($result->customer_credit); 
                                    ?>
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <?php echo $result->customer_mobile?>
                                  </td>
                                   
                                  <td>
                                    <?php echo number_format(floatval($result->customer_credit),2)?>
                                  </td>
