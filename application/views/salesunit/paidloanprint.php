    ...
    <div id="bot" style="font-weight:bold">
                    ...
                    <div id="table">
                            ...
                            <tbody>
                              ...
                              if($results!=0){
                                 foreach($results as $result){
                                   $sumofdebt+=floatval($result->loan_balance_amount); 
                                   ?>
                                   <tr>
                                     <td><?php echo $result->invoiceidsec?></td>
                                     <td><?php echo $result->customer_name?></td>
                                     <td><?php echo $result->customer_mobile?></td>
                                     <td><?php echo $result->loan_balance_amount?></td>
                                   </tr>
                                   <?php
                                 }
                                 ?>
                          ...
                          <span style="font-weight:bold">----------------------------------------------</span>  
                                   <div class='details'>
                         <div class="p-2">
                         Sum of pending debt : Rs. <?php echo number_format($sumofdebt,2)?>
                         </div>
                       </div>
                    </div><!--End Table-->
